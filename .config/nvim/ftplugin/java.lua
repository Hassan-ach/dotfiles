-- =======================================================================
-- This entire file is ONLY executed when you open a Java file.
-- This is where the configuration and starting of the LSP now lives.
-- =======================================================================

-- print("Java ftplugin loaded!") -- You can add this line to test if it's working

local jdtls = require("jdtls")
local home = os.getenv("HOME")

-- Define the project-specific workspace directory.
...
-- Define the paths for the debug adapters, also managed by Mason.
local bundles = {
	vim.fn.glob(
		vim.fn.stdpath("data")
...
local config = {
	...
	on_attach = function(client, bufnr)
		...
		map("<C-i>", jdtls.organize_imports, "Organize Imports")

		require("jdtls").setup_dap({ hotcodereplace = "auto" })
		map("<leader>jt", jdtls.test_nearest_method, "Debug Test Method")
		map("<leader>jT", jdtls.test_class, "Debug Test Class")
	end,
}

-- Finally, start the language server with our configuration.
