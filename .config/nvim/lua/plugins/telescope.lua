...
return {
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>fd", builtin.diagnostics, { desc = "View diagnostics (LSP + workspace)" })
			vim.keymap.set("n", "<leader>ds", builtin.lsp_document_symbols, { desc = "Document symbols (LSP)" })
			vim.keymap.set("n", "<leader>ws", builtin.lsp_workspace_symbols, { desc = "Workspace symbols (LSP)" })
