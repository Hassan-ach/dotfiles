...
--         enable = false -- Disable notifications completely
--       }
--     })
--   end
-- }
        ...
        opts = {
            ...
            callbacks = {
                before_saving = function()
                    -- if package.loaded["harpoon.ui"] and require("harpoon.ui").state.is_menu_open then
                    --     return false -- abort save
                    -- end
                    vim.notify("󰄳 Auto-saved at " .. vim.fn.strftime("%H:%M"), vim.log.levels.INFO, {
                        title = "AutoSave",
                        icon = "",
                        timeout = 750,
                    })
            ...
            --     for _, win in ipairs(harpoon:list():get()) do
            --         if vim.api.nvim_win_get_buf(win) == buf then
            --             return false -- Don't save when Harpoon menu is open
            --         end
            --     end
            --     return true
            -- end,
